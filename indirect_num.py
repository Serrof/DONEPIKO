    ...
    while (not converged) and (iterations < indirect_params["max_iter"]):
        ...
        for j, nu in enumerate(grid_work):
            ...
            if hd == 1:
                ...
                B = [[0.0, Y[0, 0], Y[0, 1], Y[0, 0], 0.0, 0.0, Y[0, 1], 0.0, 0.0], [0.0, Y[1, 0], Y[1, 1], Y[1, 0], 0.0, 0.0, Y[1, 1], 0.0, 0.0], [0.0, Y[2, 0], Y[2, 1], Y[2, 0], 0.0, 0.0, Y[2, 1], 0.0, 0.0], [0.0, Y[3, 0], Y[3, 1], Y[3, 0], 0.0, 0.0, Y[3, 1], 0.0, 0.0]]
            else:  # case of complete dynamics
                B = [[0.0, Y[0, 0], Y[0, 1], Y[0, 2], Y[0, 0], 0.0, 0.0, 0.0, Y[0, 1], 0.0, 0.0, 0.0, Y[0, 2], 0.0, 0.0, 0.0], [0.0, Y[1, 0], Y[1, 1], Y[1, 2], Y[1, 0], 0.0, 0.0, 0.0, Y[1, 1], 0.0, 0.0, 0.0, Y[1, 2], 0.0, 0.0, 0.0], [0.0, Y[2, 0], Y[2, 1], Y[2, 2], Y[2, 0], 0.0, 0.0, 0.0, Y[2, 1], 0.0, 0.0, 0.0, Y[2, 2], 0.0, 0.0, 0.0], [0.0, Y[3, 0], Y[3, 1], Y[3, 2], Y[3, 0], 0.0, 0.0, 0.0, Y[3, 1], 0.0, 0.0, 0.0, Y[3, 2], 0.0, 0.0, 0.0], [0.0, Y[4, 0], Y[4, 1], Y[4, 2], Y[4, 0], 0.0, 0.0, 0.0, Y[4, 1], 0.0, 0.0, 0.0, Y[4, 2], 0.0, 0.0, 0.0], [0.0, Y[5, 0], Y[5, 1], Y[5, 2], Y[5, 0], 0.0, 0.0, 0.0, Y[5, 1], 0.0, 0.0, 0.0, Y[5, 2], 0.0, 0.0, 0.0]]
            if j == 0:
                A = [-matrix(B)]
